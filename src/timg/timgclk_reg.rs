#[doc = "Reader of register TIMGCLK_REG"]
pub type R = crate::R<u32, super::TIMGCLK_REG>;
#[doc = "Writer for register TIMGCLK_REG"]
pub type W = crate::W<u32, super::TIMGCLK_REG>;
#[doc = "Register TIMGCLK_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMGCLK_REG {
    type Type = u32;
    #[inline(always)]
