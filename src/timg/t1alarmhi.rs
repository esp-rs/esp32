#[doc = "Reader of register T1ALARMHI"]
pub type R = crate::R<u32, super::T1ALARMHI>;
#[doc = "Writer for register T1ALARMHI"]
pub type W = crate::W<u32, super::T1ALARMHI>;
#[doc = "Register T1ALARMHI `reset()`'s with value 0"]
impl crate::ResetValue for super::T1ALARMHI {
    type Type = u32;
    #[inline(always)]
