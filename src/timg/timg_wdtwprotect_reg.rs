#[doc = "Reader of register TIMG_WDTWPROTECT_REG"]
pub type R = crate::R<u32, super::TIMG_WDTWPROTECT_REG>;
#[doc = "Writer for register TIMG_WDTWPROTECT_REG"]
pub type W = crate::W<u32, super::TIMG_WDTWPROTECT_REG>;
#[doc = "Register TIMG_WDTWPROTECT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMG_WDTWPROTECT_REG {
    type Type = u32;
    #[inline(always)]
