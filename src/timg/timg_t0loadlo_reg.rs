#[doc = "Reader of register TIMG_T0LOADLO_REG"]
pub type R = crate::R<u32, super::TIMG_T0LOADLO_REG>;
#[doc = "Writer for register TIMG_T0LOADLO_REG"]
pub type W = crate::W<u32, super::TIMG_T0LOADLO_REG>;
#[doc = "Register TIMG_T0LOADLO_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMG_T0LOADLO_REG {
    type Type = u32;
    #[inline(always)]
