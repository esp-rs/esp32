#[doc = "Reader of register TIMG_T0ALARMHI_REG"]
pub type R = crate::R<u32, super::TIMG_T0ALARMHI_REG>;
#[doc = "Writer for register TIMG_T0ALARMHI_REG"]
pub type W = crate::W<u32, super::TIMG_T0ALARMHI_REG>;
#[doc = "Register TIMG_T0ALARMHI_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMG_T0ALARMHI_REG {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn timg_t0_alarm_hi(&self) -> TIMG_T0_ALARM_HI_R {
        TIMG_T0_ALARM_HI_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - Timer 0 time-base counter value higher 32 bits that will trigger the alarm"]
