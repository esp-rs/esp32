#[doc = "Reader of register LACTLOADLO"]
pub type R = crate::R<u32, super::LACTLOADLO>;
#[doc = "Writer for register LACTLOADLO"]
pub type W = crate::W<u32, super::LACTLOADLO>;
#[doc = "Register LACTLOADLO `reset()`'s with value 0"]
impl crate::ResetValue for super::LACTLOADLO {
    type Type = u32;
    #[inline(always)]
