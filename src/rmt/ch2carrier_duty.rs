#[doc = "Reader of register CH2CARRIER_DUTY"]
pub type R = crate::R<u32, super::CH2CARRIER_DUTY>;
#[doc = "Writer for register CH2CARRIER_DUTY"]
pub type W = crate::W<u32, super::CH2CARRIER_DUTY>;
#[doc = "Register CH2CARRIER_DUTY `reset()`'s with value 0"]
impl crate::ResetValue for super::CH2CARRIER_DUTY {
    type Type = u32;
    #[inline(always)]
