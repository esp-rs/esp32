#[doc = "Reader of register RMT_DATE_REG"]
pub type R = crate::R<u32, super::RMT_DATE_REG>;
#[doc = "Writer for register RMT_DATE_REG"]
pub type W = crate::W<u32, super::RMT_DATE_REG>;
#[doc = "Register RMT_DATE_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RMT_DATE_REG {
    type Type = u32;
    #[inline(always)]
