#[doc = "Reader of register RMT_CH1_TX_LIM_REG"]
pub type R = crate::R<u32, super::RMT_CH1_TX_LIM_REG>;
#[doc = "Writer for register RMT_CH1_TX_LIM_REG"]
pub type W = crate::W<u32, super::RMT_CH1_TX_LIM_REG>;
#[doc = "Register RMT_CH1_TX_LIM_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RMT_CH1_TX_LIM_REG {
    type Type = u32;
    #[inline(always)]
