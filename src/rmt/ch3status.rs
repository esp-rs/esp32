...
#[doc = "Reader of field `STATUS_CH3`"]
pub type STATUS_CH3_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `STATUS_CH3`"]
pub struct STATUS_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> STATUS_CH3_W<'a> {
...
#[doc = "Write proxy for field `APB_MEM_RD_ERR_CH3`"]
pub struct APB_MEM_RD_ERR_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> APB_MEM_RD_ERR_CH3_W<'a> {
...
#[doc = "Reader of field `APB_MEM_WR_ERR_CH3`"]
pub type APB_MEM_WR_ERR_CH3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `APB_MEM_WR_ERR_CH3`"]
pub struct APB_MEM_WR_ERR_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> APB_MEM_WR_ERR_CH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `MEM_EMPTY_CH3`"]
pub type MEM_EMPTY_CH3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `MEM_EMPTY_CH3`"]
pub struct MEM_EMPTY_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_EMPTY_CH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Write proxy for field `MEM_FULL_CH3`"]
pub struct MEM_FULL_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_FULL_CH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Write proxy for field `MEM_OWNER_ERR_CH3`"]
pub struct MEM_OWNER_ERR_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_OWNER_ERR_CH3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Write proxy for field `STATE_CH3`"]
pub struct STATE_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> STATE_CH3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "Reader of field `MEM_RADDR_EX_CH3`"]
pub type MEM_RADDR_EX_CH3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `MEM_RADDR_EX_CH3`"]
pub struct MEM_RADDR_EX_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_RADDR_EX_CH3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "Write proxy for field `MEM_WADDR_EX_CH3`"]
pub struct MEM_WADDR_EX_CH3_W<'a> {
    w: &'a mut W,
}
impl<'a> MEM_WADDR_EX_CH3_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl R {
    ...
    pub fn status_ch3(&self) -> STATUS_CH3_R {
        STATUS_CH3_R::new((self.bits & 0xffff_ffff) as u32)
    }
...
impl W {
    #[doc = "Bits 0:31 - The status for channel3"]
    #[inline(always)]
    pub fn status_ch3(&mut self) -> STATUS_CH3_W {
        STATUS_CH3_W { w: self }
    }
    #[doc = "Bit 31 - The apb read memory status bit for channel3 turns to high level when the apb read address exceeds the configuration range."]
    #[inline(always)]
    pub fn apb_mem_rd_err_ch3(&mut self) -> APB_MEM_RD_ERR_CH3_W {
        APB_MEM_RD_ERR_CH3_W { w: self }
    }
    #[doc = "Bit 30 - The apb write memory status bit for channel3 turns to high level when the apb write address exceeds the configuration range."]
    #[inline(always)]
    pub fn apb_mem_wr_err_ch3(&mut self) -> APB_MEM_WR_ERR_CH3_W {
        APB_MEM_WR_ERR_CH3_W { w: self }
    }
    #[doc = "Bit 29 - The memory empty status bit for channel3. in acyclic mode, this bit turns to high level when mem_raddr_ex is greater than or equal to the configured range."]
    #[inline(always)]
    pub fn mem_empty_ch3(&mut self) -> MEM_EMPTY_CH3_W {
        MEM_EMPTY_CH3_W { w: self }
    }
    #[doc = "Bit 28 - The memory full status bit for channel3 turns to high level when mem_waddr_ex is greater than or equal to the configuration range."]
    #[inline(always)]
    pub fn mem_full_ch3(&mut self) -> MEM_FULL_CH3_W {
        MEM_FULL_CH3_W { w: self }
    }
    #[doc = "Bit 27 - When channel3 is configured for receive mode, this bit will turn to high level if rmt_mem_owner register is not set to 1."]
    #[inline(always)]
    pub fn mem_owner_err_ch3(&mut self) -> MEM_OWNER_ERR_CH3_W {
        MEM_OWNER_ERR_CH3_W { w: self }
    }
    #[doc = "Bits 24:26 - The channel3 state machine status register.3'h0 : idle, 3'h1 : send, 3'h2 : read memory, 3'h3 : receive, 3'h4 : wait."]
    #[inline(always)]
    pub fn state_ch3(&mut self) -> STATE_CH3_W {
        STATE_CH3_W { w: self }
    }
    #[doc = "Bits 12:21 - The current memory write address of channel3."]
    #[inline(always)]
    pub fn mem_raddr_ex_ch3(&mut self) -> MEM_RADDR_EX_CH3_W {
        MEM_RADDR_EX_CH3_W { w: self }
    }
    #[doc = "Bits 0:9 - The current memory read address of channel3."]
    #[inline(always)]
    pub fn mem_waddr_ex_ch3(&mut self) -> MEM_WADDR_EX_CH3_W {
        MEM_WADDR_EX_CH3_W { w: self }
    }
}
