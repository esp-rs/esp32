#[doc = "Reader of register RMT_CH2CARRIER_DUTY_REG"]
pub type R = crate::R<u32, super::RMT_CH2CARRIER_DUTY_REG>;
#[doc = "Writer for register RMT_CH2CARRIER_DUTY_REG"]
pub type W = crate::W<u32, super::RMT_CH2CARRIER_DUTY_REG>;
#[doc = "Register RMT_CH2CARRIER_DUTY_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RMT_CH2CARRIER_DUTY_REG {
    type Type = u32;
    #[inline(always)]
