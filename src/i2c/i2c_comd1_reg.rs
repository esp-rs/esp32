#[doc = "Reader of register I2C_COMD1_REG"]
pub type R = crate::R<u32, super::I2C_COMD1_REG>;
#[doc = "Writer for register I2C_COMD1_REG"]
pub type W = crate::W<u32, super::I2C_COMD1_REG>;
#[doc = "Register I2C_COMD1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::I2C_COMD1_REG {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 31 - When command1 is done in I2C Master mode this bit changes to high level."]
    #[inline(always)]
    pub fn i2c_command1_done(&self) -> I2C_COMMAND1_DONE_R {
        I2C_COMMAND1_DONE_R::new(((self.bits >> 31) & 0x01) != 0)
    }
    #[doc = "Bits 0:13 - This is the content of command1. It consists of three part. op_code is the command 0: RSTART 1: WRITE 2: READ 3: STOP . 4:END. Byte_num represent the number of data need to be send or data need to be received. ack_check_en ack_exp and ack value are used to control the ack bit."]
    #[inline(always)]
