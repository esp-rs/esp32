...
#[doc = "Reader of field `SCL_START_HOLD_TIME`"]
pub type SCL_START_HOLD_TIME_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `SCL_START_HOLD_TIME`"]
pub struct SCL_START_HOLD_TIME_W<'a> {
    w: &'a mut W,
}
impl<'a> SCL_START_HOLD_TIME_W<'a> {
...
impl R {
    ...
    pub fn scl_start_hold_time(&self) -> SCL_START_HOLD_TIME_R {
        SCL_START_HOLD_TIME_R::new((self.bits & 0x03ff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:9 - This register is used to configure the clock num between the negedge of SDA and negedge of SCL for start mark."]
    #[inline(always)]
    pub fn scl_start_hold_time(&mut self) -> SCL_START_HOLD_TIME_W {
        SCL_START_HOLD_TIME_W { w: self }
    }
}
