#[doc = "Reader of register I2C_SCL_START_HOLD_REG"]
pub type R = crate::R<u32, super::I2C_SCL_START_HOLD_REG>;
#[doc = "Writer for register I2C_SCL_START_HOLD_REG"]
pub type W = crate::W<u32, super::I2C_SCL_START_HOLD_REG>;
#[doc = "Register I2C_SCL_START_HOLD_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::I2C_SCL_START_HOLD_REG {
    type Type = u32;
    #[inline(always)]
