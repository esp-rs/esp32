#[doc = "Reader of register UART_MEM_TX_STATUS_REG"]
pub type R = crate::R<u32, super::UART_MEM_TX_STATUS_REG>;
#[doc = "Writer for register UART_MEM_TX_STATUS_REG"]
pub type W = crate::W<u32, super::UART_MEM_TX_STATUS_REG>;
#[doc = "Register UART_MEM_TX_STATUS_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_MEM_TX_STATUS_REG {
    type Type = u32;
    #[inline(always)]
