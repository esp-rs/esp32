#[doc = "Reader of register UART_CLKDIV_REG"]
pub type R = crate::R<u32, super::UART_CLKDIV_REG>;
#[doc = "Writer for register UART_CLKDIV_REG"]
pub type W = crate::W<u32, super::UART_CLKDIV_REG>;
#[doc = "Register UART_CLKDIV_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_CLKDIV_REG {
    type Type = u32;
    #[inline(always)]
