...
#[doc = "Writer for register MEM_RX_STATUS"]
pub type W = crate::W<u32, super::MEM_RX_STATUS>;
#[doc = "Register MEM_RX_STATUS `reset()`'s with value 0"]
impl crate::ResetValue for super::MEM_RX_STATUS {
    type Type = u32;
    #[inline(always)]
