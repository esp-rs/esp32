#[doc = "Reader of register UART_INT_CLR_REG"]
pub type R = crate::R<u32, super::UART_INT_CLR_REG>;
#[doc = "Writer for register UART_INT_CLR_REG"]
pub type W = crate::W<u32, super::UART_INT_CLR_REG>;
#[doc = "Register UART_INT_CLR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_INT_CLR_REG {
    type Type = u32;
    #[inline(always)]
