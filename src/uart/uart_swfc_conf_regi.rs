#[doc = "Reader of register UART_SWFC_CONF_REG(i)"]
pub type R = crate::R<u32, super::UART_SWFC_CONF_REGI>;
#[doc = "Writer for register UART_SWFC_CONF_REG(i)"]
pub type W = crate::W<u32, super::UART_SWFC_CONF_REGI>;
#[doc = "Register UART_SWFC_CONF_REG(i) `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_SWFC_CONF_REGI {
    type Type = u32;
    #[inline(always)]
