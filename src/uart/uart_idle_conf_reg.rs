#[doc = "Reader of register UART_IDLE_CONF_REG"]
pub type R = crate::R<u32, super::UART_IDLE_CONF_REG>;
#[doc = "Writer for register UART_IDLE_CONF_REG"]
pub type W = crate::W<u32, super::UART_IDLE_CONF_REG>;
#[doc = "Register UART_IDLE_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_IDLE_CONF_REG {
    type Type = u32;
    #[inline(always)]
