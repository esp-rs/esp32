#[doc = "Reader of register UART_AT_CMD_CHAR_REG(i)"]
pub type R = crate::R<u32, super::UART_AT_CMD_CHAR_REGI>;
#[doc = "Writer for register UART_AT_CMD_CHAR_REG(i)"]
pub type W = crate::W<u32, super::UART_AT_CMD_CHAR_REGI>;
#[doc = "Register UART_AT_CMD_CHAR_REG(i) `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_AT_CMD_CHAR_REGI {
    type Type = u32;
    #[inline(always)]
