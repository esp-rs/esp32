#[doc = "Reader of register UART_POSPULSE_REG"]
pub type R = crate::R<u32, super::UART_POSPULSE_REG>;
#[doc = "Writer for register UART_POSPULSE_REG"]
pub type W = crate::W<u32, super::UART_POSPULSE_REG>;
#[doc = "Register UART_POSPULSE_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_POSPULSE_REG {
    type Type = u32;
    #[inline(always)]
