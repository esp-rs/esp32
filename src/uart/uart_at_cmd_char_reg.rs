#[doc = "Reader of register UART_AT_CMD_CHAR_REG"]
pub type R = crate::R<u32, super::UART_AT_CMD_CHAR_REG>;
#[doc = "Writer for register UART_AT_CMD_CHAR_REG"]
pub type W = crate::W<u32, super::UART_AT_CMD_CHAR_REG>;
#[doc = "Register UART_AT_CMD_CHAR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UART_AT_CMD_CHAR_REG {
    type Type = u32;
    #[inline(always)]
