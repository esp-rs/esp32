#[doc = "Reader of register SYSCON_XTAL_TICK_CONF_REG"]
pub type R = crate::R<u32, super::SYSCON_XTAL_TICK_CONF_REG>;
#[doc = "Writer for register SYSCON_XTAL_TICK_CONF_REG"]
pub type W = crate::W<u32, super::SYSCON_XTAL_TICK_CONF_REG>;
#[doc = "Register SYSCON_XTAL_TICK_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCON_XTAL_TICK_CONF_REG {
    type Type = u32;
    #[inline(always)]
