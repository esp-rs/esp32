#[doc = "Reader of register SYSCON_SARADC_SAR1_PATT_TAB3_REG"]
pub type R = crate::R<u32, super::SYSCON_SARADC_SAR1_PATT_TAB3_REG>;
#[doc = "Writer for register SYSCON_SARADC_SAR1_PATT_TAB3_REG"]
pub type W = crate::W<u32, super::SYSCON_SARADC_SAR1_PATT_TAB3_REG>;
#[doc = "Register SYSCON_SARADC_SAR1_PATT_TAB3_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCON_SARADC_SAR1_PATT_TAB3_REG {
    type Type = u32;
    #[inline(always)]
