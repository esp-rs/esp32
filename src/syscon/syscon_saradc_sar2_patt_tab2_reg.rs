#[doc = "Reader of register SYSCON_SARADC_SAR2_PATT_TAB2_REG"]
pub type R = crate::R<u32, super::SYSCON_SARADC_SAR2_PATT_TAB2_REG>;
#[doc = "Writer for register SYSCON_SARADC_SAR2_PATT_TAB2_REG"]
pub type W = crate::W<u32, super::SYSCON_SARADC_SAR2_PATT_TAB2_REG>;
#[doc = "Register SYSCON_SARADC_SAR2_PATT_TAB2_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCON_SARADC_SAR2_PATT_TAB2_REG {
    type Type = u32;
    #[inline(always)]
