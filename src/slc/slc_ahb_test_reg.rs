#[doc = "Reader of register SLC_AHB_TEST_REG"]
pub type R = crate::R<u32, super::SLC_AHB_TEST_REG>;
#[doc = "Writer for register SLC_AHB_TEST_REG"]
pub type W = crate::W<u32, super::SLC_AHB_TEST_REG>;
#[doc = "Register SLC_AHB_TEST_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SLC_AHB_TEST_REG {
    type Type = u32;
    #[inline(always)]
