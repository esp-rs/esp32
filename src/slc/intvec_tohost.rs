#[doc = "Reader of register INTVEC_TOHOST"]
pub type R = crate::R<u32, super::INTVEC_TOHOST>;
#[doc = "Writer for register INTVEC_TOHOST"]
pub type W = crate::W<u32, super::INTVEC_TOHOST>;
#[doc = "Register INTVEC_TOHOST `reset()`'s with value 0"]
impl crate::ResetValue for super::INTVEC_TOHOST {
    type Type = u32;
    #[inline(always)]
