...
#[doc = "Reader of field `CMD_CONTENT0`"]
pub type CMD_CONTENT0_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `CMD_CONTENT0`"]
pub struct CMD_CONTENT0_W<'a> {
    w: &'a mut W,
}
impl<'a> CMD_CONTENT0_W<'a> {
...
impl R {
    ...
    pub fn cmd_content0(&self) -> CMD_CONTENT0_R {
        CMD_CONTENT0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn cmd_content0(&mut self) -> CMD_CONTENT0_W {
        CMD_CONTENT0_W { w: self }
    }
}
