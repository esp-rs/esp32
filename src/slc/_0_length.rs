...
#[doc = "Reader of field `SLC0_LEN`"]
pub type SLC0_LEN_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `SLC0_LEN`"]
pub struct SLC0_LEN_W<'a> {
    w: &'a mut W,
}
impl<'a> SLC0_LEN_W<'a> {
...
impl W {
    #[doc = "Bits 0:19"]
    #[inline(always)]
    pub fn slc0_len(&mut self) -> SLC0_LEN_W {
        SLC0_LEN_W { w: self }
    }
}
