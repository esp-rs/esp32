#[doc = "Reader of register APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG"]
pub type R = crate::R<u32, super::APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG>;
#[doc = "Writer for register APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG"]
pub type W = crate::W<u32, super::APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG>;
#[doc = "Register APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::APB_CTRL_APB_SARADC_SAR1_PATT_TAB3_REG {
    type Type = u32;
    #[inline(always)]
