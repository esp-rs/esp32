#[doc = "Reader of register APB_CTRL_XTAL_TICK_CONF_REG"]
pub type R = crate::R<u32, super::APB_CTRL_XTAL_TICK_CONF_REG>;
#[doc = "Writer for register APB_CTRL_XTAL_TICK_CONF_REG"]
pub type W = crate::W<u32, super::APB_CTRL_XTAL_TICK_CONF_REG>;
#[doc = "Register APB_CTRL_XTAL_TICK_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::APB_CTRL_XTAL_TICK_CONF_REG {
    type Type = u32;
    #[inline(always)]
