...
#[doc = "Reader of field `I2CEXT1_ACCESS_GRANT_CONFIG`"]
pub type I2CEXT1_ACCESS_GRANT_CONFIG_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `I2CEXT1_ACCESS_GRANT_CONFIG`"]
