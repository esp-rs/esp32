#[doc = "Reader of register DPORT_IMMU_TABLE13_REG"]
pub type R = crate::R<u32, super::DPORT_IMMU_TABLE13_REG>;
#[doc = "Writer for register DPORT_IMMU_TABLE13_REG"]
pub type W = crate::W<u32, super::DPORT_IMMU_TABLE13_REG>;
#[doc = "Register DPORT_IMMU_TABLE13_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_IMMU_TABLE13_REG {
    type Type = u32;
    #[inline(always)]
