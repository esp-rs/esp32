...
#[doc = "Reader of field `PRO_CPU_INTR_FROM_CPU_1_MAP`"]
pub type PRO_CPU_INTR_FROM_CPU_1_MAP_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `PRO_CPU_INTR_FROM_CPU_1_MAP`"]
