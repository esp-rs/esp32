#[doc = "Reader of register DPORT_APP_INTRUSION_STATUS_REG"]
pub type R = crate::R<u32, super::DPORT_APP_INTRUSION_STATUS_REG>;
#[doc = "Writer for register DPORT_APP_INTRUSION_STATUS_REG"]
pub type W = crate::W<u32, super::DPORT_APP_INTRUSION_STATUS_REG>;
#[doc = "Register DPORT_APP_INTRUSION_STATUS_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_APP_INTRUSION_STATUS_REG {
    type Type = u32;
    #[inline(always)]
