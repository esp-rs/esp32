#[doc = "Reader of register IMMU_TABLE10"]
pub type R = crate::R<u32, super::IMMU_TABLE10>;
#[doc = "Writer for register IMMU_TABLE10"]
pub type W = crate::W<u32, super::IMMU_TABLE10>;
#[doc = "Register IMMU_TABLE10 `reset()`'s with value 0"]
impl crate::ResetValue for super::IMMU_TABLE10 {
    type Type = u32;
    #[inline(always)]
