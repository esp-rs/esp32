#[doc = "Reader of register AHBLITE_MPU_TABLE_TIMERGROUP1"]
pub type R = crate::R<u32, super::AHBLITE_MPU_TABLE_TIMERGROUP1>;
#[doc = "Writer for register AHBLITE_MPU_TABLE_TIMERGROUP1"]
pub type W = crate::W<u32, super::AHBLITE_MPU_TABLE_TIMERGROUP1>;
#[doc = "Register AHBLITE_MPU_TABLE_TIMERGROUP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::AHBLITE_MPU_TABLE_TIMERGROUP1 {
    type Type = u32;
    #[inline(always)]
