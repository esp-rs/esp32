...
#[doc = "Reader of field `APP_DRAM1ADDR0_IA`"]
pub type APP_DRAM1ADDR0_IA_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `APP_DRAM1ADDR0_IA`"]
pub struct APP_DRAM1ADDR0_IA_W<'a> {
    w: &'a mut W,
}
impl<'a> APP_DRAM1ADDR0_IA_W<'a> {
...
impl W {
    #[doc = "Bits 0:19"]
    #[inline(always)]
    pub fn app_dram1addr0_ia(&mut self) -> APP_DRAM1ADDR0_IA_W {
        APP_DRAM1ADDR0_IA_W { w: self }
    }
}
