#[doc = "Reader of register DPORT_PRO_PWM0_INTR_MAP_REG"]
pub type R = crate::R<u32, super::DPORT_PRO_PWM0_INTR_MAP_REG>;
#[doc = "Writer for register DPORT_PRO_PWM0_INTR_MAP_REG"]
pub type W = crate::W<u32, super::DPORT_PRO_PWM0_INTR_MAP_REG>;
#[doc = "Register DPORT_PRO_PWM0_INTR_MAP_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_PRO_PWM0_INTR_MAP_REG {
    type Type = u32;
    #[inline(always)]
