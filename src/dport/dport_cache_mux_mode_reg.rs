#[doc = "Reader of register DPORT_CACHE_MUX_MODE_REG"]
pub type R = crate::R<u32, super::DPORT_CACHE_MUX_MODE_REG>;
#[doc = "Writer for register DPORT_CACHE_MUX_MODE_REG"]
pub type W = crate::W<u32, super::DPORT_CACHE_MUX_MODE_REG>;
#[doc = "Register DPORT_CACHE_MUX_MODE_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_CACHE_MUX_MODE_REG {
    type Type = u32;
    #[inline(always)]
