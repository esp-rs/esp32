#[doc = "Reader of register DPORT_MEM_PD_MASK_REG"]
pub type R = crate::R<u32, super::DPORT_MEM_PD_MASK_REG>;
#[doc = "Writer for register DPORT_MEM_PD_MASK_REG"]
pub type W = crate::W<u32, super::DPORT_MEM_PD_MASK_REG>;
#[doc = "Register DPORT_MEM_PD_MASK_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_MEM_PD_MASK_REG {
    type Type = u32;
    #[inline(always)]
