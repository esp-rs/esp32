#[doc = "Reader of register DPORT_APPCPU_CTRL_D_REG"]
pub type R = crate::R<u32, super::DPORT_APPCPU_CTRL_D_REG>;
#[doc = "Writer for register DPORT_APPCPU_CTRL_D_REG"]
pub type W = crate::W<u32, super::DPORT_APPCPU_CTRL_D_REG>;
#[doc = "Register DPORT_APPCPU_CTRL_D_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_APPCPU_CTRL_D_REG {
    type Type = u32;
    #[inline(always)]
