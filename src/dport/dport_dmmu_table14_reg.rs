#[doc = "Reader of register DPORT_DMMU_TABLE14_REG"]
pub type R = crate::R<u32, super::DPORT_DMMU_TABLE14_REG>;
#[doc = "Writer for register DPORT_DMMU_TABLE14_REG"]
pub type W = crate::W<u32, super::DPORT_DMMU_TABLE14_REG>;
#[doc = "Register DPORT_DMMU_TABLE14_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_DMMU_TABLE14_REG {
    type Type = u32;
    #[inline(always)]
