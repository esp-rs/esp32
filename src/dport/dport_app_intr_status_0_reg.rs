#[doc = "Reader of register DPORT_APP_INTR_STATUS_0_REG"]
pub type R = crate::R<u32, super::DPORT_APP_INTR_STATUS_0_REG>;
#[doc = "Writer for register DPORT_APP_INTR_STATUS_0_REG"]
pub type W = crate::W<u32, super::DPORT_APP_INTR_STATUS_0_REG>;
#[doc = "Register DPORT_APP_INTR_STATUS_0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_APP_INTR_STATUS_0_REG {
    type Type = u32;
    #[inline(always)]
