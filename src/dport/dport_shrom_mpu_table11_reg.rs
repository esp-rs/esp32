#[doc = "Reader of register DPORT_SHROM_MPU_TABLE11_REG"]
pub type R = crate::R<u32, super::DPORT_SHROM_MPU_TABLE11_REG>;
#[doc = "Writer for register DPORT_SHROM_MPU_TABLE11_REG"]
pub type W = crate::W<u32, super::DPORT_SHROM_MPU_TABLE11_REG>;
#[doc = "Register DPORT_SHROM_MPU_TABLE11_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_SHROM_MPU_TABLE11_REG {
    type Type = u32;
    #[inline(always)]
