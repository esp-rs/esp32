#[doc = "Reader of register AHBLITE_MPU_TABLE_BT"]
pub type R = crate::R<u32, super::AHBLITE_MPU_TABLE_BT>;
#[doc = "Writer for register AHBLITE_MPU_TABLE_BT"]
pub type W = crate::W<u32, super::AHBLITE_MPU_TABLE_BT>;
#[doc = "Register AHBLITE_MPU_TABLE_BT `reset()`'s with value 0"]
impl crate::ResetValue for super::AHBLITE_MPU_TABLE_BT {
    type Type = u32;
    #[inline(always)]
