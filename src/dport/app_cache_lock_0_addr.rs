#[doc = "Reader of register APP_CACHE_LOCK_0_ADDR"]
pub type R = crate::R<u32, super::APP_CACHE_LOCK_0_ADDR>;
#[doc = "Writer for register APP_CACHE_LOCK_0_ADDR"]
pub type W = crate::W<u32, super::APP_CACHE_LOCK_0_ADDR>;
#[doc = "Register APP_CACHE_LOCK_0_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::APP_CACHE_LOCK_0_ADDR {
    type Type = u32;
    #[inline(always)]
