#[doc = "Reader of register DPORT_ACCESS_CHECK_REG"]
pub type R = crate::R<u32, super::DPORT_ACCESS_CHECK_REG>;
#[doc = "Writer for register DPORT_ACCESS_CHECK_REG"]
pub type W = crate::W<u32, super::DPORT_ACCESS_CHECK_REG>;
#[doc = "Register DPORT_ACCESS_CHECK_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_ACCESS_CHECK_REG {
    type Type = u32;
    #[inline(always)]
