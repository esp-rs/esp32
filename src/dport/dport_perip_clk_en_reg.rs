#[doc = "Reader of register DPORT_PERIP_CLK_EN_REG"]
pub type R = crate::R<u32, super::DPORT_PERIP_CLK_EN_REG>;
#[doc = "Writer for register DPORT_PERIP_CLK_EN_REG"]
pub type W = crate::W<u32, super::DPORT_PERIP_CLK_EN_REG>;
#[doc = "Register DPORT_PERIP_CLK_EN_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_PERIP_CLK_EN_REG {
    type Type = u32;
    #[inline(always)]
