...
#[doc = "Reader of field `WIFIMAC_ACCESS_GRANT_CONFIG`"]
pub type WIFIMAC_ACCESS_GRANT_CONFIG_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `WIFIMAC_ACCESS_GRANT_CONFIG`"]
