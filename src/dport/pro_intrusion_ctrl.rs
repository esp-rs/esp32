...
#[doc = "Reader of field `PRO_INTRUSION_RECORD_RESET_N`"]
pub type PRO_INTRUSION_RECORD_RESET_N_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `PRO_INTRUSION_RECORD_RESET_N`"]
