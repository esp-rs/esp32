#[doc = "Reader of register PRO_DCACHE_DBUG9"]
pub type R = crate::R<u32, super::PRO_DCACHE_DBUG9>;
#[doc = "Writer for register PRO_DCACHE_DBUG9"]
pub type W = crate::W<u32, super::PRO_DCACHE_DBUG9>;
#[doc = "Register PRO_DCACHE_DBUG9 `reset()`'s with value 0"]
impl crate::ResetValue for super::PRO_DCACHE_DBUG9 {
    type Type = u32;
    #[inline(always)]
