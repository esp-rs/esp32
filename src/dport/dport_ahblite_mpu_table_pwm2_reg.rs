#[doc = "Reader of register DPORT_AHBLITE_MPU_TABLE_PWM2_REG"]
pub type R = crate::R<u32, super::DPORT_AHBLITE_MPU_TABLE_PWM2_REG>;
#[doc = "Writer for register DPORT_AHBLITE_MPU_TABLE_PWM2_REG"]
pub type W = crate::W<u32, super::DPORT_AHBLITE_MPU_TABLE_PWM2_REG>;
#[doc = "Register DPORT_AHBLITE_MPU_TABLE_PWM2_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_AHBLITE_MPU_TABLE_PWM2_REG {
    type Type = u32;
    #[inline(always)]
