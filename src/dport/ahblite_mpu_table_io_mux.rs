#[doc = "Reader of register AHBLITE_MPU_TABLE_IO_MUX"]
pub type R = crate::R<u32, super::AHBLITE_MPU_TABLE_IO_MUX>;
#[doc = "Writer for register AHBLITE_MPU_TABLE_IO_MUX"]
pub type W = crate::W<u32, super::AHBLITE_MPU_TABLE_IO_MUX>;
#[doc = "Register AHBLITE_MPU_TABLE_IO_MUX `reset()`'s with value 0"]
impl crate::ResetValue for super::AHBLITE_MPU_TABLE_IO_MUX {
    type Type = u32;
    #[inline(always)]
