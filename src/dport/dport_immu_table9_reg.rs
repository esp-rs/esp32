#[doc = "Reader of register DPORT_IMMU_TABLE9_REG"]
pub type R = crate::R<u32, super::DPORT_IMMU_TABLE9_REG>;
#[doc = "Writer for register DPORT_IMMU_TABLE9_REG"]
pub type W = crate::W<u32, super::DPORT_IMMU_TABLE9_REG>;
#[doc = "Register DPORT_IMMU_TABLE9_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_IMMU_TABLE9_REG {
    type Type = u32;
    #[inline(always)]
