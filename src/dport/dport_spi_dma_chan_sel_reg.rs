#[doc = "Reader of register DPORT_SPI_DMA_CHAN_SEL_REG"]
pub type R = crate::R<u32, super::DPORT_SPI_DMA_CHAN_SEL_REG>;
#[doc = "Writer for register DPORT_SPI_DMA_CHAN_SEL_REG"]
pub type W = crate::W<u32, super::DPORT_SPI_DMA_CHAN_SEL_REG>;
#[doc = "Register DPORT_SPI_DMA_CHAN_SEL_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_SPI_DMA_CHAN_SEL_REG {
    type Type = u32;
    #[inline(always)]
