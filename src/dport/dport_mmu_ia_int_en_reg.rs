#[doc = "Reader of register DPORT_MMU_IA_INT_EN_REG"]
pub type R = crate::R<u32, super::DPORT_MMU_IA_INT_EN_REG>;
#[doc = "Writer for register DPORT_MMU_IA_INT_EN_REG"]
pub type W = crate::W<u32, super::DPORT_MMU_IA_INT_EN_REG>;
#[doc = "Register DPORT_MMU_IA_INT_EN_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::DPORT_MMU_IA_INT_EN_REG {
    type Type = u32;
    #[inline(always)]
