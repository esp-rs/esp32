#[doc = "Reader of register CIS_CONF2"]
pub type R = crate::R<u32, super::CIS_CONF2>;
#[doc = "Writer for register CIS_CONF2"]
pub type W = crate::W<u32, super::CIS_CONF2>;
#[doc = "Register CIS_CONF2 `reset()`'s with value 0"]
impl crate::ResetValue for super::CIS_CONF2 {
    type Type = u32;
    #[inline(always)]
