#[doc = "Reader of register HINF_CFG_DATA7_REG"]
pub type R = crate::R<u32, super::HINF_CFG_DATA7_REG>;
#[doc = "Writer for register HINF_CFG_DATA7_REG"]
pub type W = crate::W<u32, super::HINF_CFG_DATA7_REG>;
#[doc = "Register HINF_CFG_DATA7_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::HINF_CFG_DATA7_REG {
    type Type = u32;
    #[inline(always)]
