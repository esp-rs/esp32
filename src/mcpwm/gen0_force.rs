...
#[doc = "Reader of field `GEN0_B_NCIFORCE_MODE`"]
pub type GEN0_B_NCIFORCE_MODE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GEN0_B_NCIFORCE_MODE`"]
...
#[doc = "Reader of field `GEN0_B_NCIFORCE`"]
pub type GEN0_B_NCIFORCE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GEN0_B_NCIFORCE`"]
...
#[doc = "Reader of field `GEN0_A_NCIFORCE_MODE`"]
pub type GEN0_A_NCIFORCE_MODE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GEN0_A_NCIFORCE_MODE`"]
...
#[doc = "Reader of field `GEN0_A_NCIFORCE`"]
pub type GEN0_A_NCIFORCE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GEN0_A_NCIFORCE`"]
...
#[doc = "Reader of field `GEN0_B_CNTUFORCE_MODE`"]
pub type GEN0_B_CNTUFORCE_MODE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GEN0_B_CNTUFORCE_MODE`"]
...
#[doc = "Reader of field `GEN0_A_CNTUFORCE_MODE`"]
pub type GEN0_A_CNTUFORCE_MODE_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GEN0_A_CNTUFORCE_MODE`"]
...
#[doc = "Reader of field `GEN0_CNTUFORCE_UPMETHOD`"]
pub type GEN0_CNTUFORCE_UPMETHOD_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GEN0_CNTUFORCE_UPMETHOD`"]
