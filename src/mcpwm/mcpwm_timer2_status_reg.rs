#[doc = "Reader of register MCPWM_TIMER2_STATUS_REG"]
pub type R = crate::R<u32, super::MCPWM_TIMER2_STATUS_REG>;
#[doc = "Writer for register MCPWM_TIMER2_STATUS_REG"]
pub type W = crate::W<u32, super::MCPWM_TIMER2_STATUS_REG>;
#[doc = "Register MCPWM_TIMER2_STATUS_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::MCPWM_TIMER2_STATUS_REG {
    type Type = u32;
    #[inline(always)]
