...
#[doc = "Reader of field `TIMER1_PHASE`"]
pub type TIMER1_PHASE_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `TIMER1_PHASE`"]
...
#[doc = "Reader of field `TIMER1_SYNCO_SEL`"]
pub type TIMER1_SYNCO_SEL_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TIMER1_SYNCO_SEL`"]
...
#[doc = "Reader of field `TIMER1_SYNC_SW`"]
pub type TIMER1_SYNC_SW_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER1_SYNC_SW`"]
pub struct TIMER1_SYNC_SW_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER1_SYNC_SW_W<'a> {
...
#[doc = "Reader of field `TIMER1_SYNCI_EN`"]
pub type TIMER1_SYNCI_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TIMER1_SYNCI_EN`"]
...
impl R {
    ...
    #[inline(always)]
    pub fn timer1_sync_sw(&self) -> TIMER1_SYNC_SW_R {
        TIMER1_SYNC_SW_R::new(((self.bits >> 1) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 1 - Toggling this bit will trigger a software sync"]
    #[inline(always)]
    pub fn timer1_sync_sw(&mut self) -> TIMER1_SYNC_SW_W {
        TIMER1_SYNC_SW_W { w: self }
    }
    #[doc = "Bit 0 - When set timer reload with phase on sync input event is enabled"]
    #[inline(always)]
