#[doc = "Reader of register MCPWM_DT0_FED_CFG_REG"]
pub type R = crate::R<u32, super::MCPWM_DT0_FED_CFG_REG>;
#[doc = "Writer for register MCPWM_DT0_FED_CFG_REG"]
pub type W = crate::W<u32, super::MCPWM_DT0_FED_CFG_REG>;
#[doc = "Register MCPWM_DT0_FED_CFG_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::MCPWM_DT0_FED_CFG_REG {
    type Type = u32;
    #[inline(always)]
