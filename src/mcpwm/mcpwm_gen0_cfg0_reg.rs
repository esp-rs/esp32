#[doc = "Reader of register MCPWM_GEN0_CFG0_REG"]
pub type R = crate::R<u32, super::MCPWM_GEN0_CFG0_REG>;
#[doc = "Writer for register MCPWM_GEN0_CFG0_REG"]
pub type W = crate::W<u32, super::MCPWM_GEN0_CFG0_REG>;
#[doc = "Register MCPWM_GEN0_CFG0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::MCPWM_GEN0_CFG0_REG {
    type Type = u32;
    #[inline(always)]
