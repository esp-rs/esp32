#[doc = "Reader of register MCPWM_CAP_CH1_REG"]
pub type R = crate::R<u32, super::MCPWM_CAP_CH1_REG>;
#[doc = "Writer for register MCPWM_CAP_CH1_REG"]
pub type W = crate::W<u32, super::MCPWM_CAP_CH1_REG>;
#[doc = "Register MCPWM_CAP_CH1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::MCPWM_CAP_CH1_REG {
    type Type = u32;
    #[inline(always)]
