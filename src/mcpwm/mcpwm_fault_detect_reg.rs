#[doc = "Reader of register MCPWM_FAULT_DETECT_REG"]
pub type R = crate::R<u32, super::MCPWM_FAULT_DETECT_REG>;
#[doc = "Writer for register MCPWM_FAULT_DETECT_REG"]
pub type W = crate::W<u32, super::MCPWM_FAULT_DETECT_REG>;
#[doc = "Register MCPWM_FAULT_DETECT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::MCPWM_FAULT_DETECT_REG {
    type Type = u32;
    #[inline(always)]
