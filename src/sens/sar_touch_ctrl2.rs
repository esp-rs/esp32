...
#[doc = "Reader of field `TOUCH_MEAS_EN_CLR`"]
pub type TOUCH_MEAS_EN_CLR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TOUCH_MEAS_EN_CLR`"]
...
#[doc = "Reader of field `TOUCH_SLEEP_CYCLES`"]
pub type TOUCH_SLEEP_CYCLES_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `TOUCH_SLEEP_CYCLES`"]
...
#[doc = "Reader of field `TOUCH_START_FORCE`"]
pub type TOUCH_START_FORCE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TOUCH_START_FORCE`"]
...
#[doc = "Reader of field `TOUCH_START_EN`"]
pub type TOUCH_START_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TOUCH_START_EN`"]
...
#[doc = "Reader of field `TOUCH_START_FSM_EN`"]
pub type TOUCH_START_FSM_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TOUCH_START_FSM_EN`"]
...
#[doc = "Reader of field `TOUCH_MEAS_DONE`"]
pub type TOUCH_MEAS_DONE_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `TOUCH_MEAS_DONE`"]
...
#[doc = "Reader of field `TOUCH_MEAS_EN`"]
pub type TOUCH_MEAS_EN_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `TOUCH_MEAS_EN`"]
