#[doc = "Reader of register SENS_ULP_CP_SLEEP_CYC2_REG"]
pub type R = crate::R<u32, super::SENS_ULP_CP_SLEEP_CYC2_REG>;
#[doc = "Writer for register SENS_ULP_CP_SLEEP_CYC2_REG"]
pub type W = crate::W<u32, super::SENS_ULP_CP_SLEEP_CYC2_REG>;
#[doc = "Register SENS_ULP_CP_SLEEP_CYC2_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SENS_ULP_CP_SLEEP_CYC2_REG {
    type Type = u32;
    #[inline(always)]
