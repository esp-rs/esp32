#[doc = "Reader of register SENS_SAR_TOUCH_OUT1_REG"]
pub type R = crate::R<u32, super::SENS_SAR_TOUCH_OUT1_REG>;
#[doc = "Writer for register SENS_SAR_TOUCH_OUT1_REG"]
pub type W = crate::W<u32, super::SENS_SAR_TOUCH_OUT1_REG>;
#[doc = "Register SENS_SAR_TOUCH_OUT1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SENS_SAR_TOUCH_OUT1_REG {
    type Type = u32;
    #[inline(always)]
