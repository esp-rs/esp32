#[doc = "Reader of register EFUSE_DAC_CONF_REG"]
pub type R = crate::R<u32, super::EFUSE_DAC_CONF_REG>;
#[doc = "Writer for register EFUSE_DAC_CONF_REG"]
pub type W = crate::W<u32, super::EFUSE_DAC_CONF_REG>;
#[doc = "Register EFUSE_DAC_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::EFUSE_DAC_CONF_REG {
    type Type = u32;
    #[inline(always)]
