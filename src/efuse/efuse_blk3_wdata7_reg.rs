#[doc = "Reader of register EFUSE_BLK3_WDATA7_REG"]
pub type R = crate::R<u32, super::EFUSE_BLK3_WDATA7_REG>;
#[doc = "Writer for register EFUSE_BLK3_WDATA7_REG"]
pub type W = crate::W<u32, super::EFUSE_BLK3_WDATA7_REG>;
#[doc = "Register EFUSE_BLK3_WDATA7_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::EFUSE_BLK3_WDATA7_REG {
    type Type = u32;
    #[inline(always)]
