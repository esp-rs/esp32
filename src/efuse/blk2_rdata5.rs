...
#[doc = "Reader of field `BLK2_DOUT5`"]
pub type BLK2_DOUT5_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `BLK2_DOUT5`"]
pub struct BLK2_DOUT5_W<'a> {
    w: &'a mut W,
}
impl<'a> BLK2_DOUT5_W<'a> {
...
impl R {
    ...
    pub fn blk2_dout5(&self) -> BLK2_DOUT5_R {
        BLK2_DOUT5_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - read for BLOCK2"]
    #[inline(always)]
    pub fn blk2_dout5(&mut self) -> BLK2_DOUT5_W {
        BLK2_DOUT5_W { w: self }
    }
}
