...
#[doc = "Reader of field `BLK1_DOUT2`"]
pub type BLK1_DOUT2_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `BLK1_DOUT2`"]
pub struct BLK1_DOUT2_W<'a> {
    w: &'a mut W,
}
impl<'a> BLK1_DOUT2_W<'a> {
...
impl R {
    ...
    pub fn blk1_dout2(&self) -> BLK1_DOUT2_R {
        BLK1_DOUT2_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - read for BLOCK1"]
    #[inline(always)]
    pub fn blk1_dout2(&mut self) -> BLK1_DOUT2_W {
        BLK1_DOUT2_W { w: self }
    }
}
