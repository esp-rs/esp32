#[doc = "Reader of register EFUSE_INT_CLR_REG"]
pub type R = crate::R<u32, super::EFUSE_INT_CLR_REG>;
#[doc = "Writer for register EFUSE_INT_CLR_REG"]
pub type W = crate::W<u32, super::EFUSE_INT_CLR_REG>;
#[doc = "Register EFUSE_INT_CLR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::EFUSE_INT_CLR_REG {
    type Type = u32;
    #[inline(always)]
