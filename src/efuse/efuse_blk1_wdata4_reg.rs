#[doc = "Reader of register EFUSE_BLK1_WDATA4_REG"]
pub type R = crate::R<u32, super::EFUSE_BLK1_WDATA4_REG>;
#[doc = "Writer for register EFUSE_BLK1_WDATA4_REG"]
pub type W = crate::W<u32, super::EFUSE_BLK1_WDATA4_REG>;
#[doc = "Register EFUSE_BLK1_WDATA4_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::EFUSE_BLK1_WDATA4_REG {
    type Type = u32;
    #[inline(always)]
