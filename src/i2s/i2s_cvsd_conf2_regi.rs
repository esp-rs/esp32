#[doc = "Reader of register I2S_CVSD_CONF2_REG(i)"]
pub type R = crate::R<u32, super::I2S_CVSD_CONF2_REGI>;
#[doc = "Writer for register I2S_CVSD_CONF2_REG(i)"]
pub type W = crate::W<u32, super::I2S_CVSD_CONF2_REGI>;
#[doc = "Register I2S_CVSD_CONF2_REG(i) `reset()`'s with value 0"]
impl crate::ResetValue for super::I2S_CVSD_CONF2_REGI {
    type Type = u32;
    #[inline(always)]
