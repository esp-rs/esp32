#[doc = "Reader of register I2S_PDM_FREQ_CONF_REG"]
pub type R = crate::R<u32, super::I2S_PDM_FREQ_CONF_REG>;
#[doc = "Writer for register I2S_PDM_FREQ_CONF_REG"]
pub type W = crate::W<u32, super::I2S_PDM_FREQ_CONF_REG>;
#[doc = "Register I2S_PDM_FREQ_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::I2S_PDM_FREQ_CONF_REG {
    type Type = u32;
    #[inline(always)]
