#[doc = "Reader of register IN_EOF_DES_ADDR"]
pub type R = crate::R<u32, super::IN_EOF_DES_ADDR>;
#[doc = "Writer for register IN_EOF_DES_ADDR"]
pub type W = crate::W<u32, super::IN_EOF_DES_ADDR>;
#[doc = "Register IN_EOF_DES_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::IN_EOF_DES_ADDR {
    type Type = u32;
    #[inline(always)]
