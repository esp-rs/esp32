#[doc = "Reader of register INFIFO_POP"]
pub type R = crate::R<u32, super::INFIFO_POP>;
#[doc = "Writer for register INFIFO_POP"]
pub type W = crate::W<u32, super::INFIFO_POP>;
#[doc = "Register INFIFO_POP `reset()`'s with value 0"]
impl crate::ResetValue for super::INFIFO_POP {
    type Type = u32;
    #[inline(always)]
