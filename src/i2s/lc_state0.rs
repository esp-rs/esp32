...
#[doc = "Reader of field `LC_STATE0`"]
pub type LC_STATE0_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `LC_STATE0`"]
pub struct LC_STATE0_W<'a> {
    w: &'a mut W,
}
impl<'a> LC_STATE0_W<'a> {
...
impl R {
    ...
    pub fn lc_state0(&self) -> LC_STATE0_R {
        LC_STATE0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn lc_state0(&mut self) -> LC_STATE0_W {
        LC_STATE0_W { w: self }
    }
}
