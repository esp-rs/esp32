...
#[doc = "Reader of field `CACHE_SRAM_USR_RD_CMD_BITLEN`"]
pub type CACHE_SRAM_USR_RD_CMD_BITLEN_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `CACHE_SRAM_USR_RD_CMD_BITLEN`"]
...
#[doc = "Reader of field `CACHE_SRAM_USR_RD_CMD_VALUE`"]
pub type CACHE_SRAM_USR_RD_CMD_VALUE_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `CACHE_SRAM_USR_RD_CMD_VALUE`"]
