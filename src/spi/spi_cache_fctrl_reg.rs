#[doc = "Reader of register SPI_CACHE_FCTRL_REG"]
pub type R = crate::R<u32, super::SPI_CACHE_FCTRL_REG>;
#[doc = "Writer for register SPI_CACHE_FCTRL_REG"]
pub type W = crate::W<u32, super::SPI_CACHE_FCTRL_REG>;
#[doc = "Register SPI_CACHE_FCTRL_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_CACHE_FCTRL_REG {
    type Type = u32;
    #[inline(always)]
