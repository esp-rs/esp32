#[doc = "Reader of register SPI_OUT_EOF_BFR_DES_ADDR_REG"]
pub type R = crate::R<u32, super::SPI_OUT_EOF_BFR_DES_ADDR_REG>;
#[doc = "Writer for register SPI_OUT_EOF_BFR_DES_ADDR_REG"]
pub type W = crate::W<u32, super::SPI_OUT_EOF_BFR_DES_ADDR_REG>;
#[doc = "Register SPI_OUT_EOF_BFR_DES_ADDR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_OUT_EOF_BFR_DES_ADDR_REG {
    type Type = u32;
    #[inline(always)]
