#[doc = "Reader of register SPI_SRAM_DRD_CMD_REG"]
pub type R = crate::R<u32, super::SPI_SRAM_DRD_CMD_REG>;
#[doc = "Writer for register SPI_SRAM_DRD_CMD_REG"]
pub type W = crate::W<u32, super::SPI_SRAM_DRD_CMD_REG>;
#[doc = "Register SPI_SRAM_DRD_CMD_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_SRAM_DRD_CMD_REG {
    type Type = u32;
    #[inline(always)]
