...
#[doc = "Reader of field `DMA_OUTLINK_DSCR_BF0`"]
pub type DMA_OUTLINK_DSCR_BF0_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `DMA_OUTLINK_DSCR_BF0`"]
pub struct DMA_OUTLINK_DSCR_BF0_W<'a> {
    w: &'a mut W,
}
impl<'a> DMA_OUTLINK_DSCR_BF0_W<'a> {
...
impl R {
    ...
    pub fn dma_outlink_dscr_bf0(&self) -> DMA_OUTLINK_DSCR_BF0_R {
        DMA_OUTLINK_DSCR_BF0_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - The content of next out descriptor pointer."]
    #[inline(always)]
    pub fn dma_outlink_dscr_bf0(&mut self) -> DMA_OUTLINK_DSCR_BF0_W {
        DMA_OUTLINK_DSCR_BF0_W { w: self }
    }
}
