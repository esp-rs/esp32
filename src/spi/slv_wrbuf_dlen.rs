#[doc = "Reader of register SLV_WRBUF_DLEN"]
pub type R = crate::R<u32, super::SLV_WRBUF_DLEN>;
#[doc = "Writer for register SLV_WRBUF_DLEN"]
pub type W = crate::W<u32, super::SLV_WRBUF_DLEN>;
#[doc = "Register SLV_WRBUF_DLEN `reset()`'s with value 0"]
impl crate::ResetValue for super::SLV_WRBUF_DLEN {
    type Type = u32;
    #[inline(always)]
