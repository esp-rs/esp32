#[doc = "Reader of register SPI_CTRL1_REG"]
pub type R = crate::R<u32, super::SPI_CTRL1_REG>;
#[doc = "Writer for register SPI_CTRL1_REG"]
pub type W = crate::W<u32, super::SPI_CTRL1_REG>;
#[doc = "Register SPI_CTRL1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::SPI_CTRL1_REG {
    type Type = u32;
    #[inline(always)]
