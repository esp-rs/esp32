#[doc = "Reader of register RTC_I2C_SLAVE_ADDR_REG"]
pub type R = crate::R<u32, super::RTC_I2C_SLAVE_ADDR_REG>;
#[doc = "Writer for register RTC_I2C_SLAVE_ADDR_REG"]
pub type W = crate::W<u32, super::RTC_I2C_SLAVE_ADDR_REG>;
#[doc = "Register RTC_I2C_SLAVE_ADDR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_I2C_SLAVE_ADDR_REG {
    type Type = u32;
    #[inline(always)]
