...
#[doc = "Reader of field `PLUS_CNT_U2`"]
pub type PLUS_CNT_U2_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `PLUS_CNT_U2`"]
pub struct PLUS_CNT_U2_W<'a> {
    w: &'a mut W,
}
impl<'a> PLUS_CNT_U2_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - This register stores the current pulse count value for unit2."]
    #[inline(always)]
    pub fn plus_cnt_u2(&mut self) -> PLUS_CNT_U2_W {
        PLUS_CNT_U2_W { w: self }
    }
}
