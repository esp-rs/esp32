#[doc = "Reader of register PCNT_U5_CNT_REG"]
pub type R = crate::R<u32, super::PCNT_U5_CNT_REG>;
#[doc = "Writer for register PCNT_U5_CNT_REG"]
pub type W = crate::W<u32, super::PCNT_U5_CNT_REG>;
#[doc = "Register PCNT_U5_CNT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::PCNT_U5_CNT_REG {
    type Type = u32;
    #[inline(always)]
