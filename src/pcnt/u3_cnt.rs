...
#[doc = "Reader of field `PLUS_CNT_U3`"]
pub type PLUS_CNT_U3_R = crate::R<u16, u16>;
#[doc = "Write proxy for field `PLUS_CNT_U3`"]
pub struct PLUS_CNT_U3_W<'a> {
    w: &'a mut W,
}
impl<'a> PLUS_CNT_U3_W<'a> {
...
impl W {
    #[doc = "Bits 0:15 - This register stores the current pulse count value for unit3."]
    #[inline(always)]
    pub fn plus_cnt_u3(&mut self) -> PLUS_CNT_U3_W {
        PLUS_CNT_U3_W { w: self }
    }
}
