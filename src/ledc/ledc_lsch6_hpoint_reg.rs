#[doc = "Reader of register LEDC_LSCH6_HPOINT_REG"]
pub type R = crate::R<u32, super::LEDC_LSCH6_HPOINT_REG>;
#[doc = "Writer for register LEDC_LSCH6_HPOINT_REG"]
pub type W = crate::W<u32, super::LEDC_LSCH6_HPOINT_REG>;
#[doc = "Register LEDC_LSCH6_HPOINT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH6_HPOINT_REG {
    type Type = u32;
    #[inline(always)]
