#[doc = "Reader of register LEDC_LSCH5_DUTY_R_REG"]
pub type R = crate::R<u32, super::LEDC_LSCH5_DUTY_R_REG>;
#[doc = "Writer for register LEDC_LSCH5_DUTY_R_REG"]
pub type W = crate::W<u32, super::LEDC_LSCH5_DUTY_R_REG>;
#[doc = "Register LEDC_LSCH5_DUTY_R_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH5_DUTY_R_REG {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn ledc_duty_lsch5(&self) -> LEDC_DUTY_LSCH5_R {
        LEDC_DUTY_LSCH5_R::new((self.bits & 0x01ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:24 - This register represents the current duty of the output signal for low speed channel5."]
