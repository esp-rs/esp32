#[doc = "Reader of register HSCH7_DUTY"]
pub type R = crate::R<u32, super::HSCH7_DUTY>;
#[doc = "Writer for register HSCH7_DUTY"]
pub type W = crate::W<u32, super::HSCH7_DUTY>;
#[doc = "Register HSCH7_DUTY `reset()`'s with value 0"]
impl crate::ResetValue for super::HSCH7_DUTY {
    type Type = u32;
    #[inline(always)]
