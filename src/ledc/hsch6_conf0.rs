#[doc = "Reader of register HSCH6_CONF0"]
pub type R = crate::R<u32, super::HSCH6_CONF0>;
#[doc = "Writer for register HSCH6_CONF0"]
pub type W = crate::W<u32, super::HSCH6_CONF0>;
#[doc = "Register HSCH6_CONF0 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSCH6_CONF0 {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `IDLE_LV_HSCH6`"]
pub type IDLE_LV_HSCH6_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `IDLE_LV_HSCH6`"]
...
#[doc = "Reader of field `SIG_OUT_EN_HSCH6`"]
pub type SIG_OUT_EN_HSCH6_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SIG_OUT_EN_HSCH6`"]
...
#[doc = "Reader of field `TIMER_SEL_HSCH6`"]
pub type TIMER_SEL_HSCH6_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `TIMER_SEL_HSCH6`"]
