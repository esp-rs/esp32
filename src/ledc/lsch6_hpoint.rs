#[doc = "Reader of register LSCH6_HPOINT"]
pub type R = crate::R<u32, super::LSCH6_HPOINT>;
#[doc = "Writer for register LSCH6_HPOINT"]
pub type W = crate::W<u32, super::LSCH6_HPOINT>;
#[doc = "Register LSCH6_HPOINT `reset()`'s with value 0"]
impl crate::ResetValue for super::LSCH6_HPOINT {
    type Type = u32;
    #[inline(always)]
