#[doc = "Reader of register LEDC_HSTIMER3_VALUE_REG"]
pub type R = crate::R<u32, super::LEDC_HSTIMER3_VALUE_REG>;
#[doc = "Writer for register LEDC_HSTIMER3_VALUE_REG"]
pub type W = crate::W<u32, super::LEDC_HSTIMER3_VALUE_REG>;
#[doc = "Register LEDC_HSTIMER3_VALUE_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_HSTIMER3_VALUE_REG {
    type Type = u32;
    #[inline(always)]
