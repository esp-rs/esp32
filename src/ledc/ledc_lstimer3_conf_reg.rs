#[doc = "Reader of register LEDC_LSTIMER3_CONF_REG"]
pub type R = crate::R<u32, super::LEDC_LSTIMER3_CONF_REG>;
#[doc = "Writer for register LEDC_LSTIMER3_CONF_REG"]
pub type W = crate::W<u32, super::LEDC_LSTIMER3_CONF_REG>;
#[doc = "Register LEDC_LSTIMER3_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSTIMER3_CONF_REG {
    type Type = u32;
    #[inline(always)]
