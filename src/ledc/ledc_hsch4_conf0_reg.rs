#[doc = "Reader of register LEDC_HSCH4_CONF0_REG"]
pub type R = crate::R<u32, super::LEDC_HSCH4_CONF0_REG>;
#[doc = "Writer for register LEDC_HSCH4_CONF0_REG"]
pub type W = crate::W<u32, super::LEDC_HSCH4_CONF0_REG>;
#[doc = "Register LEDC_HSCH4_CONF0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_HSCH4_CONF0_REG {
    type Type = u32;
    #[inline(always)]
