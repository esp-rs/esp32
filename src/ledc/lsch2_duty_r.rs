...
#[doc = "Writer for register LSCH2_DUTY_R"]
pub type W = crate::W<u32, super::LSCH2_DUTY_R>;
#[doc = "Register LSCH2_DUTY_R `reset()`'s with value 0"]
impl crate::ResetValue for super::LSCH2_DUTY_R {
    type Type = u32;
    #[inline(always)]
