#[doc = "Reader of register LEDC_LSCH3_HPOINT_REG"]
pub type R = crate::R<u32, super::LEDC_LSCH3_HPOINT_REG>;
#[doc = "Writer for register LEDC_LSCH3_HPOINT_REG"]
pub type W = crate::W<u32, super::LEDC_LSCH3_HPOINT_REG>;
#[doc = "Register LEDC_LSCH3_HPOINT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::LEDC_LSCH3_HPOINT_REG {
    type Type = u32;
    #[inline(always)]
...
pub type LEDC_HPOINT_LSCH3_R = crate::R<u32, u32>;
...
impl R {
    ...
    pub fn ledc_hpoint_lsch3(&self) -> LEDC_HPOINT_LSCH3_R {
        LEDC_HPOINT_LSCH3_R::new((self.bits & 0x000f_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:19 - The output value changes to high when lstimerx(x=\\[0 3\\]) selected by low speed channel3 has reached reg_hpoint_lsch3\\[19:0\\]"]
