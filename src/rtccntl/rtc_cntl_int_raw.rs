...
#[doc = "Writer for register RTC_CNTL_INT_RAW"]
pub type W = crate::W<u32, super::RTC_CNTL_INT_RAW>;
#[doc = "Register RTC_CNTL_INT_RAW `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_CNTL_INT_RAW {
    type Type = u32;
    #[inline(always)]
