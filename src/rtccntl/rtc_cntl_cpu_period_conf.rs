#[doc = "Reader of register RTC_CNTL_CPU_PERIOD_CONF"]
pub type R = crate::R<u32, super::RTC_CNTL_CPU_PERIOD_CONF>;
#[doc = "Writer for register RTC_CNTL_CPU_PERIOD_CONF"]
pub type W = crate::W<u32, super::RTC_CNTL_CPU_PERIOD_CONF>;
#[doc = "Register RTC_CNTL_CPU_PERIOD_CONF `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_CNTL_CPU_PERIOD_CONF {
    type Type = u32;
    #[inline(always)]
