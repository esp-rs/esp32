#[doc = "Reader of register RTC_CNTL_EXT_WAKEUP1_STATUS_REG"]
pub type R = crate::R<u32, super::RTC_CNTL_EXT_WAKEUP1_STATUS_REG>;
#[doc = "Writer for register RTC_CNTL_EXT_WAKEUP1_STATUS_REG"]
pub type W = crate::W<u32, super::RTC_CNTL_EXT_WAKEUP1_STATUS_REG>;
#[doc = "Register RTC_CNTL_EXT_WAKEUP1_STATUS_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_CNTL_EXT_WAKEUP1_STATUS_REG {
    type Type = u32;
    #[inline(always)]
