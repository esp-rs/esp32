#[doc = "Reader of register RTC_CNTL_EXT_WAKEUP1"]
pub type R = crate::R<u32, super::RTC_CNTL_EXT_WAKEUP1>;
#[doc = "Writer for register RTC_CNTL_EXT_WAKEUP1"]
pub type W = crate::W<u32, super::RTC_CNTL_EXT_WAKEUP1>;
#[doc = "Register RTC_CNTL_EXT_WAKEUP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_CNTL_EXT_WAKEUP1 {
    type Type = u32;
    #[inline(always)]
