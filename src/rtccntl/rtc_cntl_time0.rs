#[doc = "Reader of register RTC_CNTL_TIME0"]
pub type R = crate::R<u32, super::RTC_CNTL_TIME0>;
#[doc = "Writer for register RTC_CNTL_TIME0"]
pub type W = crate::W<u32, super::RTC_CNTL_TIME0>;
#[doc = "Register RTC_CNTL_TIME0 `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_CNTL_TIME0 {
    type Type = u32;
    #[inline(always)]
