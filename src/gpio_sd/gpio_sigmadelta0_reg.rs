#[doc = "Reader of register GPIO_SIGMADELTA0_REG"]
pub type R = crate::R<u32, super::GPIO_SIGMADELTA0_REG>;
#[doc = "Writer for register GPIO_SIGMADELTA0_REG"]
pub type W = crate::W<u32, super::GPIO_SIGMADELTA0_REG>;
#[doc = "Register GPIO_SIGMADELTA0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_SIGMADELTA0_REG {
    type Type = u32;
    #[inline(always)]
