...
pub type R = crate::R<u32, super::RTC_IO_TOUCH_CFG_REG>;
#[doc = "Writer for register RTC_IO_TOUCH_CFG_REG"]
pub type W = crate::W<u32, super::RTC_IO_TOUCH_CFG_REG>;
#[doc = "Register RTC_IO_TOUCH_CFG_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_IO_TOUCH_CFG_REG {
    type Type = u32;
    #[inline(always)]
