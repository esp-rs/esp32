#[doc = "Reader of register RTC_GPIO_ENABLE_W1TS"]
pub type R = crate::R<u32, super::RTC_GPIO_ENABLE_W1TS>;
#[doc = "Writer for register RTC_GPIO_ENABLE_W1TS"]
pub type W = crate::W<u32, super::RTC_GPIO_ENABLE_W1TS>;
#[doc = "Register RTC_GPIO_ENABLE_W1TS `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_GPIO_ENABLE_W1TS {
    type Type = u32;
    #[inline(always)]
