#[doc = "Reader of register RTC_IO_XTL_EXT_CTR"]
pub type R = crate::R<u32, super::RTC_IO_XTL_EXT_CTR>;
#[doc = "Writer for register RTC_IO_XTL_EXT_CTR"]
pub type W = crate::W<u32, super::RTC_IO_XTL_EXT_CTR>;
#[doc = "Register RTC_IO_XTL_EXT_CTR `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_IO_XTL_EXT_CTR {
    type Type = u32;
    #[inline(always)]
