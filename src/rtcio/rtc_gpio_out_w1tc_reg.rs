#[doc = "Reader of register RTC_GPIO_OUT_W1TC_REG"]
pub type R = crate::R<u32, super::RTC_GPIO_OUT_W1TC_REG>;
#[doc = "Writer for register RTC_GPIO_OUT_W1TC_REG"]
pub type W = crate::W<u32, super::RTC_GPIO_OUT_W1TC_REG>;
#[doc = "Register RTC_GPIO_OUT_W1TC_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_GPIO_OUT_W1TC_REG {
    type Type = u32;
    #[inline(always)]
