#[doc = "Reader of register RTC_IO_SAR_I2C_IO_REG"]
pub type R = crate::R<u32, super::RTC_IO_SAR_I2C_IO_REG>;
#[doc = "Writer for register RTC_IO_SAR_I2C_IO_REG"]
pub type W = crate::W<u32, super::RTC_IO_SAR_I2C_IO_REG>;
#[doc = "Register RTC_IO_SAR_I2C_IO_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_IO_SAR_I2C_IO_REG {
    type Type = u32;
    #[inline(always)]
