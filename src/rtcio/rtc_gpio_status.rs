#[doc = "Reader of register RTC_GPIO_STATUS"]
pub type R = crate::R<u32, super::RTC_GPIO_STATUS>;
#[doc = "Writer for register RTC_GPIO_STATUS"]
pub type W = crate::W<u32, super::RTC_GPIO_STATUS>;
#[doc = "Register RTC_GPIO_STATUS `reset()`'s with value 0"]
impl crate::ResetValue for super::RTC_GPIO_STATUS {
    type Type = u32;
    #[inline(always)]
