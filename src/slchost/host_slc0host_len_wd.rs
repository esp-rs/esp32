#[doc = "Reader of register HOST_SLC0HOST_LEN_WD"]
pub type R = crate::R<u32, super::HOST_SLC0HOST_LEN_WD>;
#[doc = "Writer for register HOST_SLC0HOST_LEN_WD"]
pub type W = crate::W<u32, super::HOST_SLC0HOST_LEN_WD>;
#[doc = "Register HOST_SLC0HOST_LEN_WD `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLC0HOST_LEN_WD {
    type Type = u32;
    #[inline(always)]
