#[doc = "Reader of register HOST_SLCHOST_INF_ST"]
pub type R = crate::R<u32, super::HOST_SLCHOST_INF_ST>;
#[doc = "Writer for register HOST_SLCHOST_INF_ST"]
pub type W = crate::W<u32, super::HOST_SLCHOST_INF_ST>;
#[doc = "Register HOST_SLCHOST_INF_ST `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLCHOST_INF_ST {
    type Type = u32;
    #[inline(always)]
