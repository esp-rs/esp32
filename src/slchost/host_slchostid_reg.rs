#[doc = "Reader of register HOST_SLCHOSTID_REG"]
pub type R = crate::R<u32, super::HOST_SLCHOSTID_REG>;
#[doc = "Writer for register HOST_SLCHOSTID_REG"]
pub type W = crate::W<u32, super::HOST_SLCHOSTID_REG>;
#[doc = "Register HOST_SLCHOSTID_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLCHOSTID_REG {
    type Type = u32;
    #[inline(always)]
