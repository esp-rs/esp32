#[doc = "Reader of register HOST_SLCHOST_GPIO_IN1"]
pub type R = crate::R<u32, super::HOST_SLCHOST_GPIO_IN1>;
#[doc = "Writer for register HOST_SLCHOST_GPIO_IN1"]
pub type W = crate::W<u32, super::HOST_SLCHOST_GPIO_IN1>;
#[doc = "Register HOST_SLCHOST_GPIO_IN1 `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLCHOST_GPIO_IN1 {
    type Type = u32;
    #[inline(always)]
