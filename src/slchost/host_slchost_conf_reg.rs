#[doc = "Reader of register HOST_SLCHOST_CONF_REG"]
pub type R = crate::R<u32, super::HOST_SLCHOST_CONF_REG>;
#[doc = "Writer for register HOST_SLCHOST_CONF_REG"]
pub type W = crate::W<u32, super::HOST_SLCHOST_CONF_REG>;
#[doc = "Register HOST_SLCHOST_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLCHOST_CONF_REG {
    type Type = u32;
    #[inline(always)]
