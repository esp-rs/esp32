#[doc = "Reader of register HOST_SLC1HOST_TOKEN_WDATA_REG"]
pub type R = crate::R<u32, super::HOST_SLC1HOST_TOKEN_WDATA_REG>;
#[doc = "Writer for register HOST_SLC1HOST_TOKEN_WDATA_REG"]
pub type W = crate::W<u32, super::HOST_SLC1HOST_TOKEN_WDATA_REG>;
#[doc = "Register HOST_SLC1HOST_TOKEN_WDATA_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLC1HOST_TOKEN_WDATA_REG {
    type Type = u32;
    #[inline(always)]
