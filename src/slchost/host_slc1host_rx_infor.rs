#[doc = "Reader of register HOST_SLC1HOST_RX_INFOR"]
pub type R = crate::R<u32, super::HOST_SLC1HOST_RX_INFOR>;
#[doc = "Writer for register HOST_SLC1HOST_RX_INFOR"]
pub type W = crate::W<u32, super::HOST_SLC1HOST_RX_INFOR>;
#[doc = "Register HOST_SLC1HOST_RX_INFOR `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLC1HOST_RX_INFOR {
    type Type = u32;
    #[inline(always)]
