#[doc = "Reader of register HOST_SLC0HOST_TOKEN_RDATA_REG"]
pub type R = crate::R<u32, super::HOST_SLC0HOST_TOKEN_RDATA_REG>;
#[doc = "Writer for register HOST_SLC0HOST_TOKEN_RDATA_REG"]
pub type W = crate::W<u32, super::HOST_SLC0HOST_TOKEN_RDATA_REG>;
#[doc = "Register HOST_SLC0HOST_TOKEN_RDATA_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLC0HOST_TOKEN_RDATA_REG {
    type Type = u32;
    #[inline(always)]
