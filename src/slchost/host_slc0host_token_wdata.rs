#[doc = "Reader of register HOST_SLC0HOST_TOKEN_WDATA"]
pub type R = crate::R<u32, super::HOST_SLC0HOST_TOKEN_WDATA>;
#[doc = "Writer for register HOST_SLC0HOST_TOKEN_WDATA"]
pub type W = crate::W<u32, super::HOST_SLC0HOST_TOKEN_WDATA>;
#[doc = "Register HOST_SLC0HOST_TOKEN_WDATA `reset()`'s with value 0"]
impl crate::ResetValue for super::HOST_SLC0HOST_TOKEN_WDATA {
    type Type = u32;
    #[inline(always)]
