#[doc = "Reader of register UHCI_ESCAPE_CONF_REG"]
pub type R = crate::R<u32, super::UHCI_ESCAPE_CONF_REG>;
#[doc = "Writer for register UHCI_ESCAPE_CONF_REG"]
pub type W = crate::W<u32, super::UHCI_ESCAPE_CONF_REG>;
#[doc = "Register UHCI_ESCAPE_CONF_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_ESCAPE_CONF_REG {
    type Type = u32;
    #[inline(always)]
