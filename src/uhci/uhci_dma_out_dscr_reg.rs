#[doc = "Reader of register UHCI_DMA_OUT_DSCR_REG"]
pub type R = crate::R<u32, super::UHCI_DMA_OUT_DSCR_REG>;
#[doc = "Writer for register UHCI_DMA_OUT_DSCR_REG"]
pub type W = crate::W<u32, super::UHCI_DMA_OUT_DSCR_REG>;
#[doc = "Register UHCI_DMA_OUT_DSCR_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_DMA_OUT_DSCR_REG {
    type Type = u32;
    #[inline(always)]
