#[doc = "Reader of register UHCI_ESC_CONF0_REG"]
pub type R = crate::R<u32, super::UHCI_ESC_CONF0_REG>;
#[doc = "Writer for register UHCI_ESC_CONF0_REG"]
pub type W = crate::W<u32, super::UHCI_ESC_CONF0_REG>;
#[doc = "Register UHCI_ESC_CONF0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_ESC_CONF0_REG {
    type Type = u32;
    #[inline(always)]
