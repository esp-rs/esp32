#[doc = "Reader of register UHCI_Q2_WORD1_REG"]
pub type R = crate::R<u32, super::UHCI_Q2_WORD1_REG>;
#[doc = "Writer for register UHCI_Q2_WORD1_REG"]
pub type W = crate::W<u32, super::UHCI_Q2_WORD1_REG>;
#[doc = "Register UHCI_Q2_WORD1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_Q2_WORD1_REG {
    type Type = u32;
    #[inline(always)]
