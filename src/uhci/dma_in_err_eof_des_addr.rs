#[doc = "Reader of register DMA_IN_ERR_EOF_DES_ADDR"]
pub type R = crate::R<u32, super::DMA_IN_ERR_EOF_DES_ADDR>;
#[doc = "Writer for register DMA_IN_ERR_EOF_DES_ADDR"]
pub type W = crate::W<u32, super::DMA_IN_ERR_EOF_DES_ADDR>;
#[doc = "Register DMA_IN_ERR_EOF_DES_ADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_IN_ERR_EOF_DES_ADDR {
    type Type = u32;
    #[inline(always)]
