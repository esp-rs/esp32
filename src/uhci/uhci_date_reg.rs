#[doc = "Reader of register UHCI_DATE_REG"]
pub type R = crate::R<u32, super::UHCI_DATE_REG>;
#[doc = "Writer for register UHCI_DATE_REG"]
pub type W = crate::W<u32, super::UHCI_DATE_REG>;
#[doc = "Register UHCI_DATE_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_DATE_REG {
    type Type = u32;
    #[inline(always)]
