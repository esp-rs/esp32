#[doc = "Reader of register UHCI_STATE1_REG"]
pub type R = crate::R<u32, super::UHCI_STATE1_REG>;
#[doc = "Writer for register UHCI_STATE1_REG"]
pub type W = crate::W<u32, super::UHCI_STATE1_REG>;
#[doc = "Register UHCI_STATE1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_STATE1_REG {
    type Type = u32;
    #[inline(always)]
