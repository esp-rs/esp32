#[doc = "Reader of register UHCI_AHB_TEST_REG"]
pub type R = crate::R<u32, super::UHCI_AHB_TEST_REG>;
#[doc = "Writer for register UHCI_AHB_TEST_REG"]
pub type W = crate::W<u32, super::UHCI_AHB_TEST_REG>;
#[doc = "Register UHCI_AHB_TEST_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::UHCI_AHB_TEST_REG {
    type Type = u32;
    #[inline(always)]
