#[doc = "Reader of register DMA_OUT_DSCR_BF1"]
pub type R = crate::R<u32, super::DMA_OUT_DSCR_BF1>;
#[doc = "Writer for register DMA_OUT_DSCR_BF1"]
pub type W = crate::W<u32, super::DMA_OUT_DSCR_BF1>;
#[doc = "Register DMA_OUT_DSCR_BF1 `reset()`'s with value 0"]
impl crate::ResetValue for super::DMA_OUT_DSCR_BF1 {
    type Type = u32;
    #[inline(always)]
