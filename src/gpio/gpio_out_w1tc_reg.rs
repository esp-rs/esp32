#[doc = "Reader of register GPIO_OUT_W1TC_REG"]
pub type R = crate::R<u32, super::GPIO_OUT_W1TC_REG>;
...
#[doc = "Reader of field `GPIO_OUT_DATA_W1TC`"]
pub type GPIO_OUT_DATA_W1TC_R = crate::R<u32, u32>;
#[doc = "Write proxy for field `GPIO_OUT_DATA_W1TC`"]
...
impl R {
    ...
    #[inline(always)]
    pub fn gpio_out_data_w1tc(&self) -> GPIO_OUT_DATA_W1TC_R {
        GPIO_OUT_DATA_W1TC_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31 - GPIO0~31 output value write 1 to clear"]
