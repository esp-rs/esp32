#[doc = "Reader of register GPIO_ACPU_NMI_INT1_REG"]
pub type R = crate::R<u32, super::GPIO_ACPU_NMI_INT1_REG>;
#[doc = "Writer for register GPIO_ACPU_NMI_INT1_REG"]
pub type W = crate::W<u32, super::GPIO_ACPU_NMI_INT1_REG>;
#[doc = "Register GPIO_ACPU_NMI_INT1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_ACPU_NMI_INT1_REG {
    type Type = u32;
    #[inline(always)]
