#[doc = "Reader of register GPIO_PIN20_REG"]
pub type R = crate::R<u32, super::GPIO_PIN20_REG>;
#[doc = "Writer for register GPIO_PIN20_REG"]
pub type W = crate::W<u32, super::GPIO_PIN20_REG>;
#[doc = "Register GPIO_PIN20_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PIN20_REG {
    type Type = u32;
    #[inline(always)]
