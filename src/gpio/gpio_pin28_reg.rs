#[doc = "Reader of register GPIO_PIN28_REG"]
pub type R = crate::R<u32, super::GPIO_PIN28_REG>;
#[doc = "Writer for register GPIO_PIN28_REG"]
pub type W = crate::W<u32, super::GPIO_PIN28_REG>;
#[doc = "Register GPIO_PIN28_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PIN28_REG {
    type Type = u32;
    #[inline(always)]
