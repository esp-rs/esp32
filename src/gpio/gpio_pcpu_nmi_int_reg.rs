#[doc = "Reader of register GPIO_PCPU_NMI_INT_REG"]
pub type R = crate::R<u32, super::GPIO_PCPU_NMI_INT_REG>;
#[doc = "Writer for register GPIO_PCPU_NMI_INT_REG"]
pub type W = crate::W<u32, super::GPIO_PCPU_NMI_INT_REG>;
#[doc = "Register GPIO_PCPU_NMI_INT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PCPU_NMI_INT_REG {
    type Type = u32;
    #[inline(always)]
