#[doc = "Reader of register GPIO_OUT1_W1TS_REG"]
pub type R = crate::R<u32, super::GPIO_OUT1_W1TS_REG>;
#[doc = "Writer for register GPIO_OUT1_W1TS_REG"]
pub type W = crate::W<u32, super::GPIO_OUT1_W1TS_REG>;
#[doc = "Register GPIO_OUT1_W1TS_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_OUT1_W1TS_REG {
    type Type = u32;
    #[inline(always)]
