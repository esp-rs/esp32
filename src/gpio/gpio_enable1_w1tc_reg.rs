#[doc = "Reader of register GPIO_ENABLE1_W1TC_REG"]
pub type R = crate::R<u32, super::GPIO_ENABLE1_W1TC_REG>;
#[doc = "Writer for register GPIO_ENABLE1_W1TC_REG"]
pub type W = crate::W<u32, super::GPIO_ENABLE1_W1TC_REG>;
#[doc = "Register GPIO_ENABLE1_W1TC_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_ENABLE1_W1TC_REG {
    type Type = u32;
    #[inline(always)]
