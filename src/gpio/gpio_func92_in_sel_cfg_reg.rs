#[doc = "Reader of register GPIO_FUNC92_IN_SEL_CFG_REG"]
pub type R = crate::R<u32, super::GPIO_FUNC92_IN_SEL_CFG_REG>;
#[doc = "Writer for register GPIO_FUNC92_IN_SEL_CFG_REG"]
pub type W = crate::W<u32, super::GPIO_FUNC92_IN_SEL_CFG_REG>;
#[doc = "Register GPIO_FUNC92_IN_SEL_CFG_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_FUNC92_IN_SEL_CFG_REG {
    type Type = u32;
    #[inline(always)]
