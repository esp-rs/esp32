#[doc = "Reader of register GPIO_IN1_REG"]
pub type R = crate::R<u32, super::GPIO_IN1_REG>;
#[doc = "Writer for register GPIO_IN1_REG"]
pub type W = crate::W<u32, super::GPIO_IN1_REG>;
#[doc = "Register GPIO_IN1_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_IN1_REG {
    type Type = u32;
    #[inline(always)]
