#[doc = "Reader of register GPIO_FUNC75_IN_SEL_CFG_REG"]
pub type R = crate::R<u32, super::GPIO_FUNC75_IN_SEL_CFG_REG>;
#[doc = "Writer for register GPIO_FUNC75_IN_SEL_CFG_REG"]
pub type W = crate::W<u32, super::GPIO_FUNC75_IN_SEL_CFG_REG>;
#[doc = "Register GPIO_FUNC75_IN_SEL_CFG_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_FUNC75_IN_SEL_CFG_REG {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    pub fn gpio_sig75_in_sel(&self) -> GPIO_SIG75_IN_SEL_R {
        GPIO_SIG75_IN_SEL_R::new(((self.bits >> 7) & 0x01) != 0)
    }
    ...
    pub fn gpio_func75_in_inv_sel(&self) -> GPIO_FUNC75_IN_INV_SEL_R {
        GPIO_FUNC75_IN_INV_SEL_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bits 0:5 - select one of the 256 inputs"]
    #[inline(always)]
    pub fn gpio_func75_in_sel(&self) -> GPIO_FUNC75_IN_SEL_R {
        GPIO_FUNC75_IN_SEL_R::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bit 7 - if the slow signal bypass the io matrix or not if you want setting the value to 1"]
