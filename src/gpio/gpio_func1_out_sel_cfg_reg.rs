#[doc = "Reader of register GPIO_FUNC1_OUT_SEL_CFG_REG"]
pub type R = crate::R<u32, super::GPIO_FUNC1_OUT_SEL_CFG_REG>;
#[doc = "Writer for register GPIO_FUNC1_OUT_SEL_CFG_REG"]
pub type W = crate::W<u32, super::GPIO_FUNC1_OUT_SEL_CFG_REG>;
#[doc = "Register GPIO_FUNC1_OUT_SEL_CFG_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_FUNC1_OUT_SEL_CFG_REG {
    type Type = u32;
    #[inline(always)]
...
pub type GPIO_FUNC1_OUT_SEL_R = crate::R<u16, u16>;
...
impl R {
    ...
    pub fn gpio_func1_oen_inv_sel(&self) -> GPIO_FUNC1_OEN_INV_SEL_R {
        GPIO_FUNC1_OEN_INV_SEL_R::new(((self.bits >> 11) & 0x01) != 0)
    }
    ...
    pub fn gpio_func1_oen_sel(&self) -> GPIO_FUNC1_OEN_SEL_R {
        GPIO_FUNC1_OEN_SEL_R::new(((self.bits >> 10) & 0x01) != 0)
    }
