#[doc = "Reader of register GPIO_PIN0_REG"]
pub type R = crate::R<u32, super::GPIO_PIN0_REG>;
#[doc = "Writer for register GPIO_PIN0_REG"]
pub type W = crate::W<u32, super::GPIO_PIN0_REG>;
#[doc = "Register GPIO_PIN0_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_PIN0_REG {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `GPIO_PIN0_INT_ENA`"]
pub type GPIO_PIN0_INT_ENA_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GPIO_PIN0_INT_ENA`"]
pub struct GPIO_PIN0_INT_ENA_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_PIN0_INT_ENA_W<'a> {
...
#[doc = "Reader of field `GPIO_PIN0_CONFIG`"]
pub type GPIO_PIN0_CONFIG_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `GPIO_PIN0_CONFIG`"]
pub struct GPIO_PIN0_CONFIG_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_PIN0_CONFIG_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
#[doc = "Reader of field `GPIO_PIN0_PAD_DRIVER`"]
pub type GPIO_PIN0_PAD_DRIVER_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `GPIO_PIN0_PAD_DRIVER`"]
...
impl R {
    ...
    #[inline(always)]
    pub fn gpio_pin0_int_ena(&self) -> GPIO_PIN0_INT_ENA_R {
        GPIO_PIN0_INT_ENA_R::new(((self.bits >> 13) & 0x1f) as u8)
    }
    #[doc = "Bits 11:12 - NA"]
    #[inline(always)]
    pub fn gpio_pin0_config(&self) -> GPIO_PIN0_CONFIG_R {
        GPIO_PIN0_CONFIG_R::new(((self.bits >> 11) & 0x03) as u8)
    }
...
impl W {
    #[doc = "Bits 13:17 - bit0: APP CPU interrupt enable bit1: APP CPU non-maskable interrupt enable bit3: PRO CPU interrupt enable bit4: PRO CPU non-maskable interrupt enable bit5: SDIO's extent interrupt enable"]
    #[inline(always)]
    pub fn gpio_pin0_int_ena(&mut self) -> GPIO_PIN0_INT_ENA_W {
        GPIO_PIN0_INT_ENA_W { w: self }
    }
    #[doc = "Bits 11:12 - NA"]
    #[inline(always)]
    pub fn gpio_pin0_config(&mut self) -> GPIO_PIN0_CONFIG_W {
        GPIO_PIN0_CONFIG_W { w: self }
    }
    #[doc = "Bit 10 - GPIO wake up enable only available in light sleep"]
    #[inline(always)]
