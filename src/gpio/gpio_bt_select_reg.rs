#[doc = "Reader of register GPIO_BT_SELECT_REG"]
pub type R = crate::R<u32, super::GPIO_BT_SELECT_REG>;
#[doc = "Writer for register GPIO_BT_SELECT_REG"]
pub type W = crate::W<u32, super::GPIO_BT_SELECT_REG>;
#[doc = "Register GPIO_BT_SELECT_REG `reset()`'s with value 0"]
impl crate::ResetValue for super::GPIO_BT_SELECT_REG {
    type Type = u32;
    #[inline(always)]
